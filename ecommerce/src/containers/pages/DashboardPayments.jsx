                ...
                <div className="md:pl-64 flex flex-col flex-1">
                                                ...
                                                <div className="space-y-12">
                                                    {orders.map((product) => (
                                                        ...
                                                        <>
                                                            ...
                                                            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900">Order
                                                                Details</h1>

                                                            <div
                                                                className="text-sm border-b border-gray-200 mt-2 pb-5 sm:flex sm:justify-between">
                                                                <dl className="flex">
                                                                    <dt className="text-gray-500">Transaction
                                                                        ID: &nbsp;</dt>
                  ...
                  &middot;
                                                                    ...
                                                                    <dd className="font-medium text-gray-900">
                                                                        <time
                                                                            dateTime="2021-03-22">{moment(product.date_issued).fromNow()}</time>
                                                                    </dd>
                                                                </dl>
                                                            ...
                                                            >
                                                                ...
                                                                <div
                                                                    className="mt-6 sm:col-span-7 sm:mt-0 md:row-end-1">
                                                                    <h3 className="text-lg font-medium text-gray-900">
                                                                        <Link
                                                                            to={`/product/${product.id}`}>{product.name}</Link>
                                                                    </h3>
                                                                    <p className="font-medium text-gray-900 mt-1">Transaction
                                                                        ID: {product.transaction_id}</p>
