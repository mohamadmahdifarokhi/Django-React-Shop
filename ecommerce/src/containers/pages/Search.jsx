                                                ...
                                                <>
                                                    <h3 className="-mx-2 -my-3 flow-root">
                                                        <Disclosure.Button
                                                            ...
                                                            <span
                                                                className="font-sofiapro-regular text-gray-900">Prices</span>
                                                                        ...
                                                                        if (price.id === 0) {
                                                                            return (
                                                                                <div key={index} className='form-check'>
                                                                                    ...
                                                                                    />
                                                                                    <label
                                                                                        className='ml-3 min-w-0 flex-1 text-gray-500 font-sofiapro-light'>{price.name}</label>
                                                                                </div>
                                                                            )
                                                                        } else {
                                                                            return (
                                                ...
                                                <>
                                                    <h3 className="-mx-2 -my-3 flow-root">
                                                        <Disclosure.Button
                                                            className="px-2 py-3 bg-white w-full flex items-center justify-between text-gray-400 hover:text-gray-500">
                                                            <span
                                                                className="font-sofiapro-regular text-gray-900">Filter</span>
                                                            <span className="ml-6 flex items-center">
                          {open ? (
                              <MinusSmIcon className="h-5 w-5" aria-hidden="true"/>
                          ) : (
